...
Ref: https://github.com/golang-standards/project-layout#go-directories

This is a basic layout for Go application projects. It's **`not an official standard defined by the core Go dev team`**; however, it is a set of common historical and emerging project layout patterns in the Go ecosystem. Some of these patterns are more popular than others.
...
## Gage Project Structure

In gage we also use some of the project directories. But again there isn't any official standard defined by the core Go dev team

![gage-project-structure](images/gage-project-structure.png)
